	...
	<legend align="center" style="font-size: 2em; color: #DC143C;"><b>Request for blood</b></legend><br>
		...
		<fieldset>
			...
			<table  cellpadding="10">
				...
				<td><input type="hidden" name="status" value="self">
					<input type="text" name="n"  value="<?php echo $_SESSION["rname"]; ?>" size="40" id="n" style="width: 100%" readonly></td>
				</tr>
				<tr>
				...
				<td><input type="text" name="bg"  value="<?php echo $_SESSION["obg"]; ?>" size="12" id="bg" style="width: 100%" readonly></td>
				</tr>
				<tr>
		...
		<legend align="center" style="font-size: 1.5em; color: #DC143C;"><b>Blood Requisition Details</b></legend><br>
			<table  cellpadding="10">
				...
				<td><input type="text" name="h"  value="<?php echo $_SESSION["hn"]; ?>" size="40" id="h" style="width: 100%" readonly>
					<input type="hidden" name="regid" value="<?php echo $_SESSION["r"]; ?>"></td>
				</tr>
				<tr>
