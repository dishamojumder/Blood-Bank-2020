	...
	<script language="javascript">
		function fx()
		{
			...
			if(document.f2.e.value!=="")
			{
		  		...
		  		if(f2.e.value.match(mailformat))
		  		{
		    		document.f2.pass1.focus();
...
<br>
<center>
	<form name="f2" method="POST" action="hospitalLoginBackend.php">
	<fieldset >
	<legend align="center" style="font-size: 1.5em; color: #DC143C;"><b>Hospital Login</b></legend><br>
